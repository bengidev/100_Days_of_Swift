...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func launch(angle: Int, velocity: Int) -> Void {
        createBanana(angle, velocity)
    }
    ...
    private func createPlayers() -> Void {
    ...
    private func createBanana(_ angle: Int, _ velocity: Int) -> Void {
    ...
    private func degreesToRadians(degrees: Int) -> Double {
        return Double(degrees) * Double.pi / 180
    }
    
    private func destroy(player: SKSpriteNode) -> Void {
    ...
    private func changePlayer() -> Void {
        if currentPlayer == 1 {
            currentPlayer = 2
        } else {
            currentPlayer = 1
    ...
    private func bananaHit(building: SKNode, atPoint contactPoint: CGPoint) -> Void {
