...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        answersLabel.setContentHuggingPriority(.fittingSizeLevel, for: .vertical)
        ...
        currentAnswer.setContentHuggingPriority(.fittingSizeLevel, for: .vertical)
        ...
        let clear = UIButton(type: .roundedRect)
    ...
    @objc func submitTapped(_ sender: UIButton) -> Void {
    ...
    @objc func clearTapped(_ sender: UIButton) -> Void {
        currentAnswer.text = ""
