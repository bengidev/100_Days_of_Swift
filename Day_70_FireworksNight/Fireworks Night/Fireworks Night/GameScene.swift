...
class GameScene: SKScene {
    ...
    @objc private func launchFireworks() -> Void {
    ...
    @objc private func createFirework(xMovement: CGFloat, x: Int, y: Int) -> Void {
        let node = SKNode()
    ...
    private func checkTouches(_ touches: Set<UITouch>) -> Void {
