...
class GameScene: SKScene {
    ...
    private var livesImage = [SKSpriteNode]()
    ...
    private func createSlices() -> Void {
    ...
    private func redrawActiveSlice() -> Void {
    ...
    private func playSwooshSound() -> Void {
    ...
    private func createEnemy(forceBomb: ForceBomb = .random) -> Void {
